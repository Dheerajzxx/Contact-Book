...
$search = $_GET['search'] ?? '';
if($search){
  $statement = $pdo->prepare('SELECT*FROM users WHERE firstname LIKE :search OR surname LIKE :search OR phone LIKE :search OR email LIKE :search OR password LIKE :search ORDER BY firstname ASC');  
